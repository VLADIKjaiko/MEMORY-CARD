...
def check_result():
    global number_data
    try:
        if r_answer_1.isChecked() and r_answer_1.text() == data[number_data]['right_answer']: # перевірка неправильної відповіді
            show_result('Правильно')
            number_data += 1
            show_question(number_data)
        elif r_answer_2.isChecked() and r_answer_2.text() == data[number_data]['right_answer']: # перевірка правильної відповіді
            show_result('Правильно')
            number_data += 1
            show_question(number_data)
        elif r_answer_3.isChecked() and r_answer_3.text() == data[number_data]['right_answer']: # перевірка неправильної відповіді
            show_result('Правильно')
            number_data += 1
            show_question(number_data)
        elif r_answer_4.isChecked() and r_answer_4.text() == data[number_data]['right_answer']: # перевірка неправильної відповіді
            show_result('Правильно')
            number_data += 1
            show_question(number_data)
        else:
